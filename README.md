...
[![Release: v0.8.2](https://img.shields.io/badge/release-v0.8.2-blue)](https://github.com/gsjonio/winforge/releases/tag/v0.8.2)
...
MIT ([LICENSE](LICENSE)). **Status:** active — current release **v0.8.2**.
...
MIT ([LICENSE](LICENSE)). **Status:** ativo — release atual **v0.8.2**.
